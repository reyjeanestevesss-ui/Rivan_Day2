...
Windows Server 2022:
  ...
  | Network Adapter 6 | Bridged (Replicate) | 10.62.1.8 /24 |
...
## Web Server
__Configure Web Server (net62.com)__  
1. Internet Information Services Manager
2. Create an `http` mapping for the domain `www.net62.com`
...
__Create Accounts For `net62.com`__
1. Support
2. Admin
3. User
...
~~~
!@cmd SEC-AZURE62
route add 10.0.0.0 mask 255.0.0.0 10.62.1.4 -p
route add 200.0.0.0 mask 255.255.255.0 10.62.1.4 -p
~~~
...
- A Record : utmph.net62.com : 208.8.8.11
